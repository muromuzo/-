...
export default function ReportsClient({ user, initialReports }: Props) {
  ...
  return (
    <div className="container">
      <AppTabs user={user} active="reports" description="성과보고서 입력, 자동 계산, PDF 출력, 누적 카드 확인을 성과보고서 카테고리에서만 집중 관리합니다." />
